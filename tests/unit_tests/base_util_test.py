...
def test_extract_filename_from_url(url, expected_fn):
    try:
...
def test_to_safe_filename(unsafe_fn, safe_fn):
    try:
...
def test_url_to_safe_filename(url, safe_fn):
    try:
